...
public class Http {
    public static HttpResponse post(String url, String body, Map<String, String> headers, String proxyURL, int timeout) throws MalformedURLException {
        HttpResponse result;
    ...
    public static HttpResponse get(String url, Map<String, String> headers, String proxyURL,
    ...
    public static Map<String, String> setHeaders(Map<String, String> headers) {
...
//        baseHeader.put("Connection", "close");
    ...
    public static Proxy getProxy(String proxyURL) throws MalformedURLException {
        if (proxyURL.contains("http")) {
            ...
            return new Proxy(Proxy.Type.SOCKS, new InetSocketAddress(host, Integer.parseInt(port)));
        } else {
            return null;
        }
    }
